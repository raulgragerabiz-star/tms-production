...
export function buildOrdersImportTemplate(): Buffer {
  ...
  const instructions = [
    ...
    [""],
    ["Columnas obligatorias: Nº Pedido, Fecha de entrega solicitada, SKU, Cantidad."],
    ['Dirección de entrega / Población / Provincia / Código Postal: si el ERP no las incluye en el informe de pedidos (habitual cuando la dirección vive en la ficha del cliente/socio dentro del ERP), se pueden dejar en blanco SIEMPRE que ese "Código Cliente" ya tenga una dirección por defecto cargada desde Maestros > Clientes > "Importar direcciones" (plantilla aparte: Código, Nombre, Dirección completa). Si el pedido trae su propia dirección, esa tiene prioridad. Como mínimo hace falta la dirección y el Código Postal (de uno de los dos sitios); Población y Provincia son opcionales.'],
    ...
    ["Consulta de estado: no hace falta crear ningún usuario ni contraseña. Cualquiera puede consultar el estado de un pedido en /seguimiento del Portal Cliente introduciendo el Nº de pedido y el código postal de la entrega -- solo ve ese pedido, nada más."],
    ["Email Cliente / Teléfono Contacto: son opcionales, quedan guardados como datos de contacto del punto de entrega."],
