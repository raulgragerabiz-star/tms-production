...
export default function CompanySettingsPage() {
  ...
  return (
    <div>
      ...
      {/* Fase 24 ("usuarios app" sub-fase 2): los datos fiscales/de contacto
          del emisor de documentos (antes aquí, "Datos de la empresa") pasan
          a gestionarse por almacén -- cada centro puede facturar como una
          sociedad distinta. Ver Maestros > Almacenes, sección "Datos
          fiscales (documentos)". */}
      <div className="bg-white rounded-xl border border-slate-200 p-5 max-w-2xl mt-6">
        <h2 className="text-sm font-semibold text-slate-800 mb-1">Datos fiscales de los documentos</h2>
        <p className="text-sm text-slate-500">
          El emisor que se imprime en la cabecera y el pie del albarán de entrega y del DeCA se configura ahora por
          centro, no aquí — ve a <span className="font-medium text-slate-700">Maestros → Almacenes</span>, edita el
          centro correspondiente y rellena su sección "Datos fiscales (documentos)".
        </p>
      </div>
